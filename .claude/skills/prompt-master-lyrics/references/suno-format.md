# Suno 結構標籤完整規範 (Suno Tag Reference)

> 本文檔在 Phase 2 輸出階段被 SKILL.md 載入。歌詞輸出必須遵守此規範。

## 目錄

1. [基礎骨架標籤 (Skeleton Tags)](#1-基礎骨架標籤-skeleton-tags)
2. [動態修飾標籤 (Dynamics Tags)](#2-動態修飾標籤-dynamics-tags)
...
## 1. 基礎骨架標籤 (Skeleton Tags)

每首歌**至少包含** `[intro] / [verse] / [chorus] / [outro]` 四種標籤。其餘為選用。

### [intro] — 開場
- **功能**：設定基調、確立情緒色調
- **常見修飾**：Atmospheric / Percussive / Ambient / Minimal / Cinematic
...
### [verse] — 主歌
- **功能**：敘事核心、推動故事、建立場景
- **常見修飾**：Spoken-word / Soft / Narrative / Confessional / Detached
- **歌詞密度**：中（4-8 句）
- **編號**：[verse 1] / [verse 2] / [verse 3]
- **建議**：
  - 第一人稱具體畫面（依循 [methodology.md §5](methodology.md#5-視角切換推進)）
  - 每段至少 1 個具體物件 + 1 個動作
  - 使用 family rhyme 或 assonance（不完美韻）製造前進感
...
- **常見修飾**：Rising / Harmonized / Building / Tense
- **歌詞密度**：中低（2-4 句）
- **建議**：
  - 音節密度比 verse 高（製造緊湊感）
  - 使用反問或不完美韻（吊住聽眾）
...
- **常見修飾**：Anthemic / Dynamic / Powerful / Soaring / Catchy
- **歌詞密度**：中（4-6 句）
- **建議**：
  - **第一句必須是 Hook**（最重要的金句）
  - 使用完美韻或開口韻（產生穩定與爆發感）
...
- **常見修飾**：Stripped-down / Climactic / Reflective / Sparse
- **歌詞密度**：中（3-5 句）
- **建議**：
...
### [outro] — 收尾
- **功能**：餘韻、收束、留下懸念或總結
- **常見修飾**：Fade-out / Reverb-tail / Echo / Whispered / Ambient
- **歌詞密度**：低（1-3 句或純氛圍）
- **建議**：
  - 呼應 intro（首尾相扣）
  - 可使用 Hook 的變奏或回聲
...
## 2. 動態修飾標籤 (Dynamics Tags)

用於段落間的銜接與強化，**非必選**，但能大幅提升結構張力。

### [build] — 能量堆疊
- **功能**：把能量逐層堆高，置於 chorus 前
- **歌詞建議**：使用重複短句、音節密度提升
...
- **修飾**：Bass-heavy / Melodic / Vocal-cut
- **位置**：build 或 rise 之後
...
### [climax] — 全曲頂點
- **功能**：最強烈的情緒爆發
- **修飾**：Vocal-driven / Instrumental / Full-band / Choir
...
每次 chorus 出現時，**至少 80% 歌詞要一致**（這就是「副歌」的意義 — 重複）。只在最後一次 chorus 可做變奏。
